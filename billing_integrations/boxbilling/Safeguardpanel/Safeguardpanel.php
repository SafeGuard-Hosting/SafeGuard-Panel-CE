<?php
/**
 * SafeGuard Panel — BoxBilling server manager.
 *
 * Install: copy this file to {boxbilling}/bb-library/Server/Manager/Safeguardpanel.php
 * Server config in BoxBilling: Hostname = panel host, Access Hash = the
